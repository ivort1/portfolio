const svgGitHubTemplate = document.createElement("template");
svgGitHubTemplate.innerHTML =
`
    <style>
        #svg--github {
            height: 1.5rem;
